...
<main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <a href="<?= Router::url('/note?id=' . $note['note_id']) ?>"
            class="text-blue-600 hover:text-blue-800 underline transition-colors duration-200">Back to note</a>
        ...
        <form method="post"
            ...
            <button class="btn btn-soft btn-primary btn-sm mt-2">Update Note</button>
        </form>
    </div>
</main>
