...
<main>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form action="<?= Router::url('/signup') ?>" method="POST" class="space-y-6">
        ...
        <p class="mt-10 text-center text-sm text-gray-500">
            ...
            <a href="<?= Router::url('/signin') ?>" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Sign in</a>
        </p>
    </div>
    </div>
</main>
